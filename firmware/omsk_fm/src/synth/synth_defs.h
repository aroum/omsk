...
typedef struct {
    ...
    uint8_t adv_sync_mode;
    uint8_t adv_scale_key;
...
static inline float adv_sync_mode_to_beat_mult(uint8_t mode) {
    static const float beat_mults[ADV_SYNC_MODE_COUNT] = {
        32.0f, 32.0f*2/3, 16.0f, 16.0f*2/3, 4.0f, 4.0f*2/3, 2.0f, 2.0f*2/3,
        1.0f, 1.0f*2/3, 0.5f, 0.5f*2/3, 0.25f, 0.25f*2/3, 0.125f, 0.125f*2/3,
        0.0625f, 0.0625f*2/3
    };
    if (mode >= ADV_SYNC_MODE_COUNT) mode = 8;
